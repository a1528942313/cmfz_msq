...
<head>
    ...
    <style>
        body{
            background-image: url("${pageContext.request.contextPath}/login/assets/img/backgrounds/1.jpg");
        }
    </style>
    <!-- CSS -->
    ...
    <script type="application/javascript">
        $(function () {
            $("#captchaImage").click(function () {
                $(".captchaImage").attr("src","${pageContext.request.contextPath}/Admin/image?time="+new Date());
            });
        });
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/Admin/login" method="post"
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 38px" class="captchaImage" src="${pageContext.request.contextPath}/Admin/image">
